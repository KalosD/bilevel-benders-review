...
\begin{algorithm}[H]
    ...
    初始化当前双层最优解为0\;
    \While{求解HPR问题的分支定界Gap未缩减到0}{
        \If{当前节点的解整数可行}{
            令$(x^*,y^*)$为当前节点HPR问题的整数可行解, 计算代表下层问题的值函数$\Phi(x^*)$\;
            \If{$d^Ty^*\leq \Phi(x^*)$}{
                向当前节点HPR问题中添加约束: $d^Ty\leq \Phi(x^*)$得到当前节点的受限HPR问题, 并求解受限HPR问题(固定上层变量, 并添加约束后的HPR问题)\;
                \If{受限HPR问题的最优解优于当前双层最优解}{
                    更新当前双层最优解\;
                }
            }\Else{
                可能更新当前双层最优解\;
...
\begin{table}[H]
    ...
    \begin{tabular}{c|c}
        ...
        \textbf{项目} & \textbf{数值} \\
        \midrule
        最大年净收益 & 8273120.86190396 \\
        最大年综合收益 & 19434979.510692075 \\
        风电场装机容量 & 20000.000000000065 \\
        光伏电站装机容量 & 5061.820158530317 \\
        储能电站装机容量 & 569.4938179841215 \\
        储能电站电池容量 & 1138.987635968243 \\
